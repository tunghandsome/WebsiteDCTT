			    	...
			    	?>
						<table class="tblone">
							...
							<tr>
								...
								<td><a href="details.php?proid=<?php echo $result['productId'] ?>">
									<img src="admin/uploads/<?php echo $result['image'] ?> " alt=""/></td>
								...
								<td><a href="details.php?proid=<?php echo $result['productId'] ?>">return</a></td>
							</tr>
							<?php 
